...
Image(filename='/Users/gracecallow/DS-3001-8/data/adult/IMG_3680.png', width=300, height=300)
```
...
#Alcohol Data
alc_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/alcohol.csv")
...
#| include: false
#Literacy Rate Data
lit_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/Literacy_rate_data.csv")
...
#Population Data
pop_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/pop_data.csv")
...
#Birth Rate Data
birth_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/birthratedata.csv")
...
primary_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/primary_edu_LF.csv")
...
murder_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/intentional_homocide.csv")
...
unem_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/unemploymentdata.csv")
...
#GDP Data
gdp_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/gdpdata.csv")
...
#Death Rate Data
death_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/deathdata.csv")
...
labor_df = pd.read_csv("/Users/gracecallow/DS-3001-8/data/adult/laborparticipation.csv")
...
#print social.png, make the size smaller
from IPython.display import Image
Image(filename='/Users/gracecallow/DS-3001-8/data/adult/Screen Shot 2023-12-04 at 5.38.05 PM.jpeg', width=300, height=300)
```
...
#print social.png, make the size smaller
from IPython.display import Image
Image(filename='/Users/gracecallow/DS-3001-8/data/adult/Screen Shot 2023-12-04 at 10.14.18 PM.png', width=300, height=300)
```
```{python}
#Evaluate the quality of the clustering using total variance explained and silhouette scores
total_sum_squares = np.sum((clust_data - np.mean(clust_data))**2)
...
We did not have any protected classes for any of our variables, so it was not necessary to do a fairness assesment.
